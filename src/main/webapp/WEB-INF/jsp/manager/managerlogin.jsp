...
<center>
    ${msg}
    <form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/mlogin">
        <table width="344" height="95" border="0" cellpadding="0" cellspacing="1" style="background-color: #3A8ECD; color: #000;">
            <tr>
                <td height="30" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF">管理员登录</td>
            </tr>
            <tr>
                <td width="114" height="30" align="right" valign="middle" bgcolor="#FFFFFF">管理员id：</td>
            ...
            <tr>
                ...
                <td height="20" align="left" valign="middle" bgcolor="#FFFFFF"><label for="textfield2"></label>
                    <input type="password" name="mpassword" /></td>
            </tr>
            <tr>
